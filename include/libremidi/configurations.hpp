...
using input_api_configuration = std::variant<
    ...
    jack_ump::input_configuration, libremidi::API>;
...
using output_api_configuration = std::variant<
    ...
    jack_ump::output_configuration, winuwp_output_configuration, libremidi::API>;
...
using observer_api_configuration = std::variant<
    ...
    jack_ump::observer_configuration, libremidi::API>;
